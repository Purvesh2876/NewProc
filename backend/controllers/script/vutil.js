...
const {TAG_UUID,TAG_GR_UUID,TAG_STREAM_CFG,TAG_TIME_CFG,TAG_EMAIL_CFG,TAG_VIDEO_CFG,TAG_DISPLAY_CFG,TAG_OSD_CFG,TAG_RECORD_CFG,TAG_IMAGE_CFG,TAG_MD_CFG,TAG_DEV_INFO,TAG_NET_INFO,TAG_PTZ_INFO,
    TAG_VIDEO_CH011,TAG_VIDEO_CH012,TAG_VIDEO_CH013,TAG_RECORD_CH011,TAG_RECORD_CH012,TAG_RECORD_SCH,ADDR_ID_BROADCAST,ADDR_ID_CONF_SERVER,MSG_TYPE_ALARM
...
function encodePTZCfg(cfg) {
    ...
    msg += addTag("currTiltPos", cfg.farPos.currTiltPos);
    msg += addTag("currZoomPos", cfg.nearPos.currZoomPos);
    msg += addEndTag(TAG_IMAGE_CFG);
...
module.exports = {
    getDefaultCfg,isNwInfoValid,isDevInfoValid,isMdCfgValid,isImageCfgValid,
    isSchValid,isRecordCfgValid,isOsdCfgValid,isDisplayCfgValid,
    isVideoCfgValid,isEmailCfgValid,isTimeCfgValid,isTelnetCfgValid,
    isStreamCfgValid,VUtil_isUuidValid,VUtil_validateConfig,
    VUtil_getMsgString,VUtil_getStringFromBuff,VUtil_hrSchToSch,
    VUtil_schToHrSch,parseWeekStr,VUtil_parseStatLine,VUtil_parseMdLine,
    parseIntTag,parseStringTag,printNwInfo,printNwInfo,printDevInfo,
    getDefaultSettings,VUtil_encodeMsgHeader,VUtil_decodeMsgHeader,VUtil_getStreamId,
    VUtil_packInt,VUtil_parseInt,encodeTimeCfg,encodeStreamCfg,encodeGrUuid,encodeUuid,
    VUtil_encodeMsg,VUtil_decodeGetConfigMsg,
